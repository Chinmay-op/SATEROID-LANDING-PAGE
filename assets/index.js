...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ha(e,t,n){let r=new Float32Array(Oa),i=new G(0,1,0);return new Si({name:`SphericalGaussianBlur`,defines:{n:Oa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ga(),fragmentShader:`
	...
	`}var Ka=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ci(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,Fc=({className:e,style:t,wispDensity:n=1,dpr:r,mouseSmoothTime:i=0,mouseTiltStrength:a=.01,horizontalBeamOffset:o=.1,verticalBeamOffset:s=0,flowSpeed:c=.35,verticalSizing:l=2,horizontalSizing:u=.5,fogIntensity:d=.45,fogScale:f=.3,wispSpeed:p=15,wispIntensity:m=5,flowStrength:h=.25,decay:g=1.1,falloffStart:v=1.2,fogFallSpeed:y=.6,color:b=`#FF79C6`})=>{let x=(0,_.useRef)(null),S=(0,_.useRef)(null),C=(0,_.useRef)(null),w=(0,_.useRef)(!1),T=(0,_.useRef)(null),E=(0,_.useRef)(1),D=(0,_.useRef)(1),O=(0,_.useRef)({width:0,height:0,dpr:0}),k=(0,_.useRef)([]),A=(0,_.useRef)(performance.now()),j=(0,_.useRef)(16.7),ee=(0,_.useRef)(!1),te=(0,_.useRef)(!0),M=e=>{let t=e.trim();t[0]===`#`&&(t=t.slice(1)),t.length===3&&(t=t.split(``).map(e=>e+e).join(``));let n=parseInt(t,16)||16777215;return{r:(n>>16&255)/255,g:(n>>8&255)/255,b:(n&255)/255}};return(0,_.useEffect)(()=>{let e=x.current,t=new Ac({antialias:!1,alpha:!1,depth:!1,stencil:!1,powerPreference:`high-performance`,premultipliedAlpha:!1,preserveDrawingBuffer:!1,failIfMajorPerformanceCaveat:!1,logarithmicDepthBuffer:!1});S.current=t,E.current=Math.min(r??(window.devicePixelRatio||1),2),D.current=E.current,t.setPixelRatio(D.current),t.shadowMap.enabled=!1,t.outputColorSpace=$e,t.setClearColor(0,1);let _=t.domElement;_.style.width=`100%`,_.style.height=`100%`,_.style.display=`block`,e.appendChild(_);let b=new Nn,M=new Yi(-1,1,1,-1,0,1),ne=new Dr;ne.setAttribute(`position`,new fr(new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),3));let N={iTime:{value:0},iResolution:{value:new G(1,1,1)},iMouse:{value:new Wt(0,0,0,0)},uWispDensity:{value:n},uTiltScale:{value:a},uFlowTime:{value:0},uFogTime:{value:0},uBeamXFrac:{value:o},uBeamYFrac:{value:s},uFlowSpeed:{value:c},uVLenFactor:{value:l},uHLenFactor:{value:u},uFogIntensity:{value:d},uFogScale:{value:f},uWSpeed:{value:p},uWIntensity:{value:m},uFlowStrength:{value:h},uDecay:{value:g},uFalloffStart:{value:v},uFogFallSpeed:{value:y},uColor:{value:new G(1,1,1)},uFade:{value:+!!w.current}};C.current=N;let P=new Ci({vertexShader:Nc,fragmentShader:Pc,uniforms:N,transparent:!1,depthTest:!1,depthWrite:!1,blending:1}),re=new Xr(ne,P);re.frustumCulled=!1,b.add(re);let ie=new fa,ae=0,F=+!!w.current,oe=new Et(0,0),I=new Et(0,0),se=()=>{let n=e.clientWidth||1,r=e.clientHeight||1,i=D.current,a=O.current,o=Math.abs(n-a.width)>.5||Math.abs(r-a.height)>.5,s=Math.abs(i-a.dpr)>.01;!o&&!s||(O.current={width:n,height:r,dpr:i},t.setPixelRatio(i),t.setSize(n,r,!1),N.iResolution.value.set(n*i,r*i,i),T.current=_.getBoundingClientRect(),ee.current||t.render(b,M))},ce=0,le=()=>{ce&&cancelAnimationFrame(ce),ce=requestAnimationFrame(se)};se();let ue=new ResizeObserver(le);ue.observe(e);let de=new IntersectionObserver(e=>{te.current=e[0]?.isIntersecting??!0},{root:null,threshold:0});de.observe(e);let fe=()=>{ee.current=document.hidden};document.addEventListener(`visibilitychange`,fe,{passive:!0});let pe=(e,t)=>{let n=T.current;if(!n)return;let r=e-n.left,i=t-n.top,a=D.current,o=n.height*a;oe.set(r*a,o-i*a)},L=e=>pe(e.clientX,e.clientY),me=()=>oe.set(0,0);_.addEventListener(`pointermove`,L,{passive:!0}),_.addEventListener(`pointerdown`,L,{passive:!0}),_.addEventListener(`pointerenter`,L,{passive:!0}),_.addEventListener(`pointerleave`,me,{passive:!0});let he=e=>{e.preventDefault(),ee.current=!0},ge=()=>{ee.current=!1,le()};_.addEventListener(`webglcontextlost`,he,!1),_.addEventListener(`webglcontextrestored`,ge,!1);let _e=0,ve=(e,t,n)=>Math.max(t,Math.min(n,e)),ye=.6,be=0,xe=e=>{if(e-A.current<750)return;let t=k.current;if(t.length===0){A.current=e;return}let n=t.reduce((e,t)=>e+t,0)/t.length,r=D.current,i=E.current;n<50?r=ve(D.current*.85,ye,i):n>58&&D.current<i&&(r=ve(D.current*1.1,ye,i)),Math.abs(r-D.current)>.01&&e-be>2e3&&(D.current=r,be=e,se()),k.current=[],A.current=e},Se=()=>{if(_e=requestAnimationFrame(Se),ee.current||!te.current)return;let e=ie.getElapsedTime(),n=Math.max(0,e-ae);ae=e;let r=n*1e3;j.current=j.current*.9+r*.1;let a=1e3/Math.max(1,j.current);k.current.push(a),N.iTime.value=e;let o=Math.min(.033,Math.max(.001,n));N.uFlowTime.value+=o,N.uFogTime.value+=o,w.current||(F=Math.min(1,F+o/1),N.uFade.value=F,F>=1&&(w.current=!0));let s=Math.max(.001,i),c=1-Math.exp(-o/s);I.lerp(oe,c),N.iMouse.value.set(I.x,I.y,0,0),t.render(b,M),xe(performance.now())};return Se(),()=>{cancelAnimationFrame(_e),ue.disconnect(),de.disconnect(),document.removeEventListener(`visibilitychange`,fe),_.removeEventListener(`pointermove`,L),_.removeEventListener(`pointerdown`,L),_.removeEventListener(`pointerenter`,L),_.removeEventListener(`pointerleave`,me),_.removeEventListener(`webglcontextlost`,he),_.removeEventListener(`webglcontextrestored`,ge),ne.dispose(),P.dispose(),t.dispose(),t.forceContextLoss(),e.contains(_)&&e.removeChild(_)}},[r]),(0,_.useEffect)(()=>{let e=C.current;if(!e)return;e.uWispDensity.value=n,e.uTiltScale.value=a,e.uBeamXFrac.value=o,e.uBeamYFrac.value=s,e.uFlowSpeed.value=c,e.uVLenFactor.value=l,e.uHLenFactor.value=u,e.uFogIntensity.value=d,e.uFogScale.value=f,e.uWSpeed.value=p,e.uWIntensity.value=m,e.uFlowStrength.value=h,e.uDecay.value=g,e.uFalloffStart.value=v,e.uFogFallSpeed.value=y;let{r:t,g:r,b:i}=M(b||`#FFFFFF`);e.uColor.value.set(t,r,i)},[n,a,o,s,c,l,u,d,f,p,m,h,g,v,y,b]),(0,Mc.jsx)(`div`,{ref:x,className:`laser-flow-container ${e||``}`,style:t})},Ic=document.getElementById(`hero-visual-react-root`);Ic&&v.createRoot(Ic).render((0,Mc.jsx)(_.StrictMode,{children:(0,Mc.jsx)(`div`,{style:{width:`100%`,height:`100%`,position:`absolute`,top:0,left:0,zIndex:0},children:(0,Mc.jsx)(Fc,{color:`#1A4A8A`,wispDensity:1,flowSpeed:.35,verticalSizing:2,horizontalSizing:.5,fogIntensity:.45,fogScale:.3,wispSpeed:15,wispIntensity:5,flowStrength:.25,decay:1.1,horizontalBeamOffset:0,verticalBeamOffset:-.5})})}));